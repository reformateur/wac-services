...
@Component({
  selector: 'app-service-equipement-and-technologies',
  templateUrl: './service-equipement-and-technologies.component.html',
  styleUrls: ['./service-equipement-and-technologies.component.scss']
})
export class ServiceEquipementAndTechnologiesComponent implements OnInit {
